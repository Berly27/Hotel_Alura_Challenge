	...
	public void calcularValor(JDateChooser fechaE, JDateChooser fechaS ) {
		 if(fechaE.getDate() != null && fechaS.getDate() != null) {
			 if(fechaE.getDate().after(fechaS.getDate())) {
				 JOptionPane.showMessageDialog(null, "La fecha de entrada no puede ser posterior al la fecha de salida", "Error en fechas", JOptionPane.ERROR_MESSAGE);
				 return;
			 }
